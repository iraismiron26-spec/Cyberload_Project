"""
╔══════════════════════════════════════════════════════════╗
║         CYBERLOAD — Descargador Cyberpunk  v1.8          ║
║         KivyMD + mstl_logic.py                          ║
║         Instagram · TikTok · YouTube · Facebook          ║
║         Compatible: Pydroid 3 / Android APK              ║
╚══════════════════════════════════════════════════════════╝

Sin cambios de lógica en v1.8 — el código de permisos
y el crash log ya eran correctos desde v1.7.
...
class CyberLoadApp(MDApp):
    ...
    def on_start(self):
        ...
        try:
            ...
            # MANAGE_EXTERNAL_STORAGE solo en Android 11+ (API 30+).
            # try/except AttributeError evita crash en Android 8 y 9.
            try:
...
#  Guarda cualquier excepción en /sdcard/cyberload_error.txt
# ─────────────────────────────────────────────────────────
